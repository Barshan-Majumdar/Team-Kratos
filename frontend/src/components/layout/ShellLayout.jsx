  ...
  return (
    <div className="flex h-screen w-screen bg-[#FAF9F6] overflow-hidden p-0 gap-0 relative flex-col">
      ...
      <div className={`flex flex-1 min-h-0 min-w-0 overflow-hidden w-full h-full relative p-0 md:p-3 md:gap-3 ${user && !user.emailVerified ? 'mt-9' : ''}`}>
        ...
        {/* Mobile Header */}
        <div className="md:hidden absolute top-0 left-0 w-full h-16 bg-[#FAF9F6] z-30 flex items-center px-4 border-b border-slate-200">
        <button 
      ...
      `}>
        ...
        {/* Main Content Area */}
        <main className="flex-1 min-h-0 min-w-0 rounded-none md:rounded-[28px] bg-[#FAF9F6] overflow-y-auto relative w-full">
