    ...
    >
      ...
      {biometricUnlock?.unlocked && (
        <motion.div
          ...
          className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 bg-amber-50 border border-amber-200 rounded-2xl sm:rounded-[20px] p-4 sm:px-6 sm:py-4 shadow-sm"
        >
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div>
              <p className="text-xs sm:text-sm font-extrabold text-amber-800 tracking-tight">Biometric Update Available</p>
          ...
          <a
            ...
            className="shrink-0 inline-flex items-center justify-center gap-2 bg-amber-600 hover:bg-amber-700 text-white text-xs font-bold px-4 sm:px-5 py-2.5 rounded-full transition-all duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)] active:scale-95 shadow-sm hover:shadow-md whitespace-nowrap w-full sm:w-auto"
          >
            <ScanFace size={14} strokeWidth={2.5} />
            <span>Update My Biometrics</span>
          </a>
        </motion.div>
      )}

      {/* Executive Hero Banner & Streak Pill */}
      <motion.div variants={itemVariants} className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 sm:gap-6">
        <div>
          {/* Eyebrow greeting pill */}
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white border border-[#EAE7E0] shadow-xs mb-2 sm:mb-3 animate-float">
            <greeting.Icon size={14} className={greeting.badgeBg.split(' ')[1]} />
            <span className="text-[10px] sm:text-[11px] font-bold uppercase tracking-wider text-[#0f172a] font-mono">
              {greeting.text}
            </span>
            <span className="w-1.5 h-1.5 rounded-full bg-[#10B981] animate-pulse-glow" />
          </div>

          <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-[3.25rem] font-bold text-[#000000] tracking-[-0.03em] font-palagio leading-tight sm:leading-none">
            Dashboard
          </h1>
          <p className="text-[#111827] text-xs sm:text-base md:text-[1.05rem] font-medium mt-1.5 sm:mt-3 max-w-2xl leading-relaxed">
        ...
        {totalAbsentDays > 69 && (
          <motion.div variants={itemVariants} className="shrink-0 w-full sm:w-auto">
            <div className="bg-[#F8FAFC] rounded-2xl sm:rounded-[20px] border border-[#94A3B8] shadow-sm p-3.5 sm:px-5 sm:py-3 flex items-center justify-between sm:justify-start gap-4 transition-colors">
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-[14px] bg-gradient-to-br from-amber-500 to-orange-500 text-white flex items-center justify-center shadow-[0_0_15px_rgba(245,158,11,0.3)] shrink-0">
                <Flame size={22} className="fill-amber-100 drop-shadow-sm" />
              </div>
              <div>
                <div className="flex items-center gap-1.5">
                ...
                <p className="text-2xl sm:text-[2rem] font-black text-[#0f172a] font-kpi tracking-[-0.04em] mt-0.5 flex items-baseline leading-none">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 mb-4 sm:mb-6">
              <div className="flex items-center gap-3">
                ...
                <div className="title-text">
                  <h2 className="text-xl sm:text-2xl md:text-[26px] font-semibold text-[#0f172a] font-palagio tracking-tight margin-0 leading-tight">
                    Leave Balances
                  </h2>
                  <p className="text-xs sm:text-[13px] text-[#64748B] font-sans mt-0.5 font-medium">
              ...
              <div className="flex flex-wrap items-center gap-2 sm:gap-2.5 w-full sm:w-auto justify-between sm:justify-end">
                <span className="font-mono text-[11px] sm:text-[12px] font-semibold bg-white border border-[#CBD5E1]/80 text-[#475569] px-3 sm:px-4 py-1.5 sm:py-2 rounded-full inline-flex items-center gap-1.5 shadow-2xs">
                  {balances.length} Policies Configured
                </span>
                <Link
                  to="/dashboard/time-off"
                  className="font-sans font-semibold text-xs sm:text-[14px] bg-gradient-to-b from-[#1E293B] to-[#0F172A] hover:from-black hover:to-[#0F172A] text-white px-4 sm:px-5 py-2 sm:py-2.5 rounded-full inline-flex items-center gap-1.5 sm:gap-2 transition-all duration-200 shadow-[0_4px_14px_rgba(15,23,42,0.25)] hover:shadow-[0_6px_20px_rgba(15,23,42,0.35)] hover:-translate-y-0.5 active:translate-y-0 group"
                >
                        ...
                        <div className="flex flex-col justify-between h-full">
                          <div>
                            ...
                            <div className="flex items-baseline gap-2 mb-1.5">
                              <span className="font-sans font-black text-3xl sm:text-4xl md:text-[44px] leading-none tracking-tight text-black">
                            ...
                            <div className="flex flex-wrap items-center gap-3 sm:gap-5 my-2.5 sm:my-3.5 text-xs sm:text-[13px] text-[#1e293b]">
                              <span className="flex items-center font-medium">
                                <span className="w-2 h-2 rounded-full inline-block mr-1.5 shrink-0" style={{ background: theme.color }} />
                                Used <b className="text-black font-bold ml-1 font-mono"><AnimatedCounter value={bal.used} />d</b>
                              </span>
                              <span className="flex items-center font-medium">
                                <span className="w-2 h-2 rounded-full inline-block mr-1.5 bg-[#64748B] shrink-0" />
                                Pending <b className="text-black font-bold ml-1 font-mono">{bal.pending || 0}d</b>
                              </span>
                            </div>

                            {/* Tickbar: Signature Day-Tick Bar */}
                            <div className="flex gap-1 sm:gap-1.5 mt-2.5 overflow-hidden">
                            ...
                            <div className="flex justify-between items-center mt-2.5 font-mono text-[10px] sm:text-[11px] font-semibold text-[#475569]">
                              <span>0</span>
