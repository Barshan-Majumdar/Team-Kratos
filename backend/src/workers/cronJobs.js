...
const initCronJobs = () => {
  ...
  // 6. Attrition Risk Scoring (Runs every night at 4:00 AM)
  ...
  // 7. Colocation Network Graph Precomputation (Runs every night at 4:30 AM)
  ...
  console.log('[CRON] Background jobs initialized (7 scheduled).');
};
