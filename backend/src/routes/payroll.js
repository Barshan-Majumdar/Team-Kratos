...
router.get('/advances', auth, authorize(2), payrollController.getAllAdvances);
router.put('/advance/:id/status', auth, authorize(2), payrollController.updateAdvanceStatus);
